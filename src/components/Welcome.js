                                    ...
                                    <>
                                        ...
                                        <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-left text-gray-500">
                                            <ul className="list-disc px-4">
                                                ...
                                                <li>The rules for word acceptability can be found <a href="https://github.com/chowder/glypoon/blob/main/RULES.md" target="_blank" rel="noreferrer" className="underline text-blue-500">here</a></li>
                                            </ul>
                                        </Disclosure.Panel>
                                    </>
                                )}
